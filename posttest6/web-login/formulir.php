...
if (isset($_POST['simpan'])) { 
    ...
    $gender   = $_POST['gender'];
    $gambar   = $_POST['gambar'];
    if ($nama && $judul_anime && $umur && $gender && $gambar) {
        if ($op == 'edit') { 
            $sql1       = "update character_anime set nama = '$nama',judul_anime='$judul_anime',umur = '$umur',gender='$gender',gambar='$gambar' where id = '$id'";
            $q1         = mysqli_query($conn, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into character_anime(nama,judul_anime,umur,gender) values ('$nama','$judul_anime','$umur','$gender','$gambar')";
            $q1     = mysqli_query($conn, $sql1);
            if ($q1) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="file" class="col-sm-2 col-form-label">Umur</label>
                        <div class="col-sm-10">
